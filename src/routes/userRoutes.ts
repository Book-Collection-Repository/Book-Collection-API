...
userRoutes.get("/:id", userController.searchUserForId.bind(userController));
userRoutes.get("/profile/:profileName", userController.searchUserForProfileName.bind(userController));
