...
bookRoutes.post("/:idBook", authValidationToken, checkingUserExists, bookController.addtingBookInDataBase.bind(bookController));
bookRoutes.delete("/:id", authValidationToken, checkingUserExists, bookController.removeBookInDataBase.bind(bookController));
